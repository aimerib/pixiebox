describe Pixiebox::DockerCompose::Config do
  describe '#initialize' do
    subject { described_class.new config_yml}
    let(:config_yml) { "#{Pixiebox.root}/spec/acceptance/fixtures/docker_compose_test.yml" }
    ...
    it 'raises a FileNotFoundError if no docker_compose present' do
      ...
      }.to raise_error(Pixiebox::Errors::FileNotFoundError)
    end
